...
@Service("eweProvinceService")
@Transactional
public class EweProvinceServiceImpl extends CommonServiceImpl implements EweProvinceServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(EweProvinceEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(EweProvinceEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(EweProvinceEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(EweProvinceEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,EweProvinceEntity t){
