...
public class QuestionServiceImpl extends CommonServiceImpl implements QuestionServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(QuestionEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(QuestionEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(QuestionEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(QuestionEntity t){
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("id", t.getId());
		map.put("theme", t.getTheme());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,QuestionEntity t){
