...
@Service("eweParamService")
@Transactional
public class EweParamServiceImpl extends CommonServiceImpl implements EweParamServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(EweParamEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(EweParamEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(EweParamEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(EweParamEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,EweParamEntity t){
