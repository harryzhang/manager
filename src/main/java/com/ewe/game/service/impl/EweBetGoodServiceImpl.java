...
@Service("eweBetGoodService")
@Transactional
public class EweBetGoodServiceImpl extends CommonServiceImpl implements EweBetGoodServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(EweBetGoodEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(EweBetGoodEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(EweBetGoodEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(EweBetGoodEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,EweBetGoodEntity t){
