...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="eweGoodsController.do?doAdd" tiptype="1" >
					<input id="goodsid" name="goodsid" type="hidden" value="${eweGoodsPage.goodsid }">
					<input id="status" name="status" type="hidden" value="1">
					<input id="gunite" name="gunite" type="hidden" value="1">
					<input id="gkind" name="gkind" type="hidden" value="1">
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="gname" name="gname" type="text" style="width: 150px" class="inputxt" >
					...
					<td class="value">
					     	 <input id="gdesc" name="gdesc" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="price" name="price" type="text" datatype="d" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="bandname" name="bandname" type="text" style="width: 150px" class="inputxt" >
...
<!-- 					     	 <input id="gcate" name="gcate" type="text" style="width: 150px" class="inputxt" > -->
								<t:dictSelect field="gcate" typeGroupCode="gCate"  hasLabel="false" defaultVal="1"></t:dictSelect>
							<span class="Validform_checktip"></span>
					...
					<td class="value">
<!-- 					     	 <input id="gcate" name="gcate" type="text" style="width: 150px" class="inputxt" > -->
								<t:dictSelect field="gcode" typeGroupCode="gCode"  hasLabel="false" defaultVal="G_JIFENG"></t:dictSelect>
							<span class="Validform_checktip"></span>
...
<%-- 		<t:upload name="fiels" buttonText="上传文件" uploader="systemController.do?saveFiles"  extend="pic" id="file_upload"  formData="imagesrc"></t:upload> --%>
	<t:ckfinder name="imagesrc" uploadType="Images"  width="100" height="60" buttonClass="ui-button" buttonValue="上传图片"></t:ckfinder>
							<span class="Validform_checktip"></span>
...
<!-- 					     	 <input id="bigimagesrc" name="bigimagesrc" type="text" style="width: 150px" class="inputxt" > -->
								<t:ckfinder name="bigimagesrc" uploadType="Images"  width="100" height="60" buttonClass="ui-button" buttonValue="上传图片"></t:ckfinder>
