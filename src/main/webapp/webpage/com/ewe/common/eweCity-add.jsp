...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="eweCityController.do?doAdd" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="cityid" name="cityid" type="text" style="width: 150px" class="inputxt"  datatype="*">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="fatherid" name="fatherid" type="text" style="width: 150px" class="inputxt"  datatype="*">
							<span class="Validform_checktip"></span>
