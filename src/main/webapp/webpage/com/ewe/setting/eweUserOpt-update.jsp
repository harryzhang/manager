...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="eweUserOptController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="userId" name="userId" type="text" style="width: 150px" class="inputxt"  value='${eweUserOptPage.userId}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="pointType" name="pointType" type="text" style="width: 150px" class="inputxt"  value='${eweUserOptPage.pointType}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="amount" name="amount" type="text" style="width: 150px" class="inputxt"  value='${eweUserOptPage.amount}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="remark" name="remark" type="text" style="width: 150px" class="inputxt"  value='${eweUserOptPage.remark}'>
							<span class="Validform_checktip"></span>
