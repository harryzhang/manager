...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="userAgentApplyController.do?doAdd" tiptype="1" >
...
>    
				...
				<tr>
					...
					<td class="value">
							   <input id="approvtime" name="approvtime" type="text" style="width: 150px" 
					      						class="Wdate" onClick="WdatePicker()"
>    
							<span class="Validform_checktip"></span>
