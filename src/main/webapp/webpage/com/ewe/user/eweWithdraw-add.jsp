...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="eweWithdrawController.do?doAdd" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="withdrawcode" name="withdrawcode" type="text" style="width: 150px" class="inputxt" >
				...
				<tr>
					...
					<td class="value">
					     	 <input id="charge" name="charge" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
...
>    
				...
				<tr>
					...
					<td class="value">
					     	 <input id="withdrawstatus" name="withdrawstatus" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="paystatus" name="paystatus" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
