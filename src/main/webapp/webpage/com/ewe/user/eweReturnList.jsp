...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="eweWithdrawList" checkbox="true" fitColumns="false" title="提现列表" actionUrl="eweWithdrawController.do?datagrid&withdrawstatus=2" idField="withdrawid" fit="true" queryMode="group">
...
<%--    <t:dgDelOpt title="删除" url="eweWithdrawController.do?doDel&id={id}" /> --%>
...
<%--    <t:dgToolBar title="批量删除"  icon="icon-remove" url="eweWithdrawController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar> --%>
