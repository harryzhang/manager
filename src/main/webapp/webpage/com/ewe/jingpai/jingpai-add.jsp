...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="jingpaiController.do?doAdd" tiptype="1" >
...
>    
					...
					<td class="value">
					     	 <input id="startprice" name="startprice" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="endprice" name="endprice" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="lastuser" name="lastuser" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							   <input id="usertime" name="usertime" type="text" style="width: 150px" 
					      						class="Wdate" onClick="WdatePicker()"
>    
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="lastprice" name="lastprice" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">竞拍底价</label>
						</td>
					</tr>
				<tr>
					<td align="right">
