...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="jingpaiList" checkbox="true" fitColumns="false" title="竞拍管理" actionUrl="jingpaiController.do?datagrid" idField="id" fit="true" queryMode="group">
   <t:dgCol title="id"  field="id"  hidden="true"  queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="商品"  field="goods.gName"    queryMode="group"  width="120"></t:dgCol>
...
<%--    <t:dgCol title="竞拍结束时间"  field="endtime" formatter="yyyy-MM-dd"   queryMode="group"  width="120"></t:dgCol> --%>
   ...
   <t:dgCol title="竞拍底价"  field="endprice"    queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="竞拍当前价格"  field="lastprice"    queryMode="group"  width="120"></t:dgCol>
