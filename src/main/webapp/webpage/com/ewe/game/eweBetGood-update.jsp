...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="eweBetGoodController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="periods" name="periods" type="text" style="width: 150px" class="inputxt"  value='${eweBetGoodPage.periods}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="betnumber" name="betnumber" type="text" style="width: 150px" class="inputxt"  value='${eweBetGoodPage.betnumber}'>
							<span class="Validform_checktip"></span>
